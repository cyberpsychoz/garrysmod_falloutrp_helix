...
LANGUAGE = {
	...
	introTextOne = "Крыжовник представляет",
	...
	chooseDescription = "Настройте внешность",
	...
	youreDead = "Вы обрели вечный покой",
	...
	noRecog = "Этот человек вам не знаком.",
	curTime = "Время: %s.",
